...
alias dev-up="docker compose -f docker-compose.yml -f docker-compose.dev.yml up"
...
## backend dev typeorm
alias back-dev-typeorm='docker compose -f docker-compose.yml -f docker-compose.dev.yml exec back pnpm run typeorm'
alias back-dev-seed='docker compose -f docker-compose.yml -f docker-compose.dev.yml exec back pnpm run seed'
alias back-dev-seed-config='docker compose -f docker-compose.yml -f docker-compose.dev.yml exec back pnpm run seed:config'
alias back-dev-seed-run='docker compose -f docker-compose.yml -f docker-compose.dev.yml exec back pnpm run seed:run'
